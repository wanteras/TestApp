...
const restaurantData = [

    {
        ...
        menu: [

            {
                ...
                description: "Canadian Bacon, homemade pizza crust, pizz sauce",
                calories:250,
                price:15
            },
...

    {
        ...
        menu: [
            ...
            {
                menuId: 13,
                name: "Nasi LemBriyani with Mutton ",
...

    {
        ...
        menu:[
...

            {
                ...
                description: "Shaved Ice with red beans Peng",
                calories: 100,
                price: 3
            },
            ...
            <View style = {{flexDirection:'row', height:50}}>
             <TouchableOpacity
                ...
                <View style = {{flex:1, alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    >
                        <Text style = {{ ...FONTS.h4}}>Chisinau</Text>
